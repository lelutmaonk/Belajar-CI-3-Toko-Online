<div class="container-fluid">
    ...
    <div class="carousel-inner">
        ...
        <img src="<?php echo base_url('assets/img/silder2.png')?>" class="d-block w-100" alt="...">
        </div>
    </div>
    ...
    <div class="row text-center mt-3">
        ...
        <?php foreach($pakaian_anak_anak as $brg) : ?>
            ...
            <img src="<?php echo base_url().'/uploads/'.$brg->gambar ?>" class="card-img-top" alt="" height="250">
            <div class="card-body">
